...
import { loginStart, loginSuccess, loginFailure } from '@/app/store/userSlice';
          ...
          <Card className="border border-gray-300 rounded-lg">
            ...
            <CardContent className="space-y-4">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  <Label className="text-sm font-bold">Sign in as</Label>
                  <RadioGroup
                    value={formData.role}
                  ...
                  >
                    <RadioGroupItem
                      value="customer"
                      id="role-customer"
                      className="h-4 w-4 border-gray-300 focus:ring-yellow-500"
                    />
          ...
          <div className="mt-6">
            ...
            <div className="mt-4">
              <Link href="/auth/signup">
                <Button
                  variant="outline"
                  className="w-full h-8 text-sm font-normal border-gray-400 hover:bg-gray-50"
                >
